...
for lt, ln, el in zip(lat,lon,elev):
    fg.add_child(folium.Marker(location=[lt,ln], popup=str(el)+"m", icon=folium.Icon(color=color_producer(el))))  # adds a marker with a location, message/popup, and color
map.add_child(fg)
